  ...
  return (
    <div className="p-4 sm:p-6 bg-white rounded-xl w-full max-w-md text-left shadow-lg border border-gray-100 mx-auto">
      ...
      >
        ...
        <button
          type="submit"
          className="mt-2 w-full rounded-lg bg-green-600 px-4 py-2.5 text-white font-semibold shadow-md transition hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
        >
          Sign Up
        </button>
      </form>
